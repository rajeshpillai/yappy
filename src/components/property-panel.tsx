                                        ...
                                        <div class="control-row">
                                            ...
                                            >
                                                ...
                                                <optgroup label="Back Entrances">
                                                    ...
                                                    <option value="backInRight">Back In Right</option>
                                                ...
                                                <optgroup label="Fading Entrances">
                                                    ...
                                                    <option value="fadeInTopLeft">Fade In Top Left</option>
                                                    <option value="fadeInTopRight">Fade In Top Right</option>
                                                    <option value="fadeInBottomLeft">Fade In Bottom Left</option>
                                                    <option value="fadeInBottomRight">Fade In Bottom Right</option>
                                                </optgroup>
                                                ...
                                                <optgroup label="Lightspeed">
                                                    <option value="lightSpeedInRight">Light Speed In Right</option>
                                                    <option value="lightSpeedInLeft">Light Speed In Left</option>
                                                </optgroup>
                                                ...
                                                <option value="scaleIn">Scale In (Custom)</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="control-row">
                                            ...
                                            >
                                                ...
                                                <optgroup label="Back Exits">
                                                    <option value="backOutDown">Back Out Down</option>
                                                    <option value="backOutLeft">Back Out Left</option>
                                                    <option value="backOutRight">Back Out Right</option>
                                                    <option value="backOutUp">Back Out Up</option>
                                                </optgroup>
                                                ...
                                                <optgroup label="Fading Exits">
                                                    ...
                                                    <option value="fadeOutTopLeft">Fade Out Top Left</option>
                                                    <option value="fadeOutTopRight">Fade Out Top Right</option>
                                                    <option value="fadeOutBottomRight">Fade Out Bottom Right</option>
                                                    <option value="fadeOutBottomLeft">Fade Out Bottom Left</option>
                                                </optgroup>
                                                ...
                                                <optgroup label="Lightspeed">
                                                    <option value="lightSpeedOutRight">Light Speed Out Right</option>
                                                    <option value="lightSpeedOutLeft">Light Speed Out Left</option>
                                                </optgroup>
                                                ...
                                                <option value="scaleOut">Scale Out (Custom)</option>
                                            </select>
                                        </div>
